...
### 🧩 Tugas 2 — Migration & Seeder  
Membuat tabel **Book** dan **Author** menggunakan **Laravel Migration**, serta menambahkan **5 data dummy** dengan **Seeder**.  
Mengatur model, controller, routing, dan view agar data tampil di halaman web.

### 🧩 Tugas 3 — API & JSON Response  
- Memindahkan semua routing ke **`routes/api.php`**,  
- menyesuaikan controller agar output berupa **JSON**, dan melakukan **testing menggunakan Postman**.  
- File view dihapus karena pembelajaran berfokus pada API.
